  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-sm p-6">
      ...
      <form onSubmit={submit} className="space-y-3">
        ...
        <button className="w-full rounded-lg bg-gray-900 text-white py-2">Login</button>
      </form>
      <p className="text-sm text-gray-600 mt-3">No account? <Link className="underline" to="/signup">Sign up</Link></p>
    </div>
  )
}
